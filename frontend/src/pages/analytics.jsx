        ...
        <div className="pt-16">
            ...
            <div className="pb-10 px-4">
                <p className="pt-10 font-medium text-2xl md:text-4xl max-w-[1100px] mx-auto">
                    Results For {data?.businessName}
                </p>

                <div className="border-2 border-[#d8cfbf] max-w-[1000px] mx-auto flex flex-col md:flex-row items-center md:items-center justify-between gap-6 p-6">
                    <div>
                        <OverallScoreRing score={data?.overallScore || 0} />
                    </div>
                    <div className="flex-1 md:ml-10  md:text-left">
                        <section className="overall-card">
                            <div className="font-bold text-xl md:text-2xl">Overall Digital Presence Score</div>
                            <p className="text-[#837a6c]">Combined score across all metrics</p>
                            <div className="text-[#9b7618] border-1 p-1 w-20  md:mx-0">{data?.status}</div>
                            <p className="max-w-lg  md:mx-0">{data?.summary}</p>
                            
                        </section>
                    </div>
                    <div className="flex flex-col md:flex-col gap-2 w-full md:w-auto">
                        <button className="text-white bg-black h-12 flex-1 md:flex-none md:w-48">Download Report</button>
                        <button className="h-12 border-2 flex-1 md:flex-none md:w-48">Analyze Another Business</button>
                    </div>
                </div>
